...
export const getAuthorizedUserSuccess = (user) => ({ type: GET_AUTHORIZED_USER_SUCCESS, payload: user })
export const getAuthorizedUserFailed = (error) => ({ type: GET_AUTHORIZED_USER_FAILED, payload: error })
export const getAuthorizedUserStarted = () => ({ type: GET_AUTHORIZED_USER_STARTED })

export const mutateUserSuccess = () => ({ type: MUTATE_USER_SUCCESS })
export const mutateUserFailed = (error) => ({ type: MUTATE_USER_FAILED, payload: error })
export const mutateUserStarted = () => ({ type: MUTATE_USER_SUCCESS })